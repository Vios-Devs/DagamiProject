...
?>
    ...
    <div id="random-photos">
        <div class="container">
            <h2 class="white-text">Random Photos in Dagami</h2>
            ...
            <!-- <div class="grid-wrap">
                <div class="each-box box-1">    
                    <div class="bg-white">
                        <p class="inner-title">Quick View</p>
                    </div>
                </div>
                <div class="each-box box-2">    
                    <div class="bg-white">
                        <p class="inner-title">Quick View</p>
                    </div>
                </div>
                <div class="each-box box-3">    
                    <div class="bg-white">
                        <p class="inner-title">Quick View</p>
                    </div>
                </div>
                <div class="each-box box-4">    
                    <div class="bg-white">
                        <p class="inner-title">Quick View</p>
                    </div>
                </div>
